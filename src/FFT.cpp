...
void FFT::setup(int _bufsize, int _sampling_rate)
{
    bufsize = _bufsize;
...
void FFT::update(float *_input_sound)
{
    powerSpectrum(0,
                  (int)bufsize/2,
                   _input_sound,
...
int FFT::getFreqSpectrum(float freq, int half, float *magnitude)
{
}

float FFT::getFreqStep(int sampling_rate, int buffer_size)
{
